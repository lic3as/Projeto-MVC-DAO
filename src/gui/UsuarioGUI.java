...
public class UsuarioGUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        usuario.setEmail(cpf.getText());
        usuario.setTelefone(telefone.getText());
        
        
        System.out.println("Salvo");
        
        if ((nome.getText().isEmpty()) || (cpf.getText().isEmpty()) || (cpf.getText().isEmpty()) || (telefone.getText().isEmpty())) {
            JOptionPane.showMessageDialog(null, "Os campos não podem retornar vazios");} 
        else{UsuarioDAO DAO = new UsuarioDAO();
